...
public class DevInitData implements BeforeInitData {
    ...
    CommandLineRunner initData(MemberService memberService, ProductService productService) {
        return args -> {
            ...
            String type = "TOP";
            // product init
            productService.create("타이틀1", "1 설명입니다.", 100000,type);
            productService.create("타이틀2", "2 설명입니다.", 20000,type);
            productService.create("타이틀3", "3 설명입니다.", 3000000,type);
            productService.create("타이틀4", "4 설명입니다.", 40000,type);
